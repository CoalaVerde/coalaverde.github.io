...
<img alt="A kitten running from two creepers on a bright grass field" src="/avatar.png" style="shape-outside: url(/avatar.png); shape-margin: 1em; float: left; border-radius: 50%; max-width: 100%; outline: solid white 1px;">
